...
if len(orphaned):
    ind_violations.append(tag(orphaned, "stg_menu_page does NOT exist as an id in stg_menu", "stg_menu_page"))
...
#adding voilations to csv
if len(orphaned):
    ind_violations.append(tag(orphaned, "stg_menu_item does NOT exist as an id in stg_menu_page", "stg_menu_item"))
...
#adding voilations to csv
if len(orphaned):
    ind_violations.append(tag(orphaned, "stg_menu_item does NOT exist as an id in stg_dish", "stg_menu_item"))
